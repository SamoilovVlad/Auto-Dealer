            ...
            <div className="container">
                ...
                <div className="bottom">
                    ...
                    <div className="right">
                        ...
                        <div className="remove">{/*<i class="material-icons">clear</i>*/}</div>
                    </div>
                </div>
            </div>
